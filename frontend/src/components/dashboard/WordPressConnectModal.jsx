...
import { Check, Copy, ChevronDown, Download, Loader2 } from 'lucide-react';
...
const API_KEY = 'jalwa_live_abc123xyz';

export const WordPressConnectModal = ({ open, onClose, onConnected }) => {
  const [step, setStep] = useState(1);
  const [url, setUrl] = useState('https://myblog.com');
          ...
          <div className="p-6">
            ...
            {step === 1 && !done && (
              <div data-testid="wp-step-1">
                <h3 className="font-semibold text-[#0A0A0A] mb-1">Enter your WordPress site URL</h3>
            ...
            {step === 3 && !done && (
              <div data-testid="wp-step-3">
                ...
                <div className="flex gap-2 mb-6">
                  <Input value={API_KEY} readOnly className="flex-1 border-[#F0F0F0] bg-[#F9FAFB] font-mono" data-testid="wp-api-key" />
                  <Button variant="outline" onClick={copyKey} className="border-[#F0F0F0]"><Copy size={14} /></Button>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <Button onClick={handleTestAndConnect} disabled={testing} className="bg-[#1D9E75] hover:bg-[#0F6E56] text-white" data-testid="wp-test-connect">
